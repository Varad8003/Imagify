...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        > True Text to <span className="text-blue-600">image</span>,in seconds.</motion.h1>
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                ...
                className="rounded hover:scale-105 transistion-all duration-300 cursor-pointer max-sm:w-10 " src={index%2===0 ? assets.sample_img_1 : assets.sample_img_2} key={index} width={70}></motion.img>
            ))}
        </motion.div>
        <motion.p
        initial={{opacity:0}}
